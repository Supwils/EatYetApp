        ...
        protected String doInBackground(String... strings) {
            if (!TConfirm_password.equals(Tpassword)) {
                ...
                try {
                    ...
                    String query = "SELECT * FROM Uaccount WHERE Uname='" + Create_Account.this.name.getText().toString() + "'";
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            ...
                            connect = connectionHelper.connectionclass();
                            if (connect != null) {
                                query = "INSERT INTO Uaccount (Uname,Upassword,Uavailability) VALUES ('" + name.getText().toString() + "','" + password.getText().toString() + "',1)";
